...
void ImGui::Scrollbar(ImGuiAxis axis)
{
    ...
    // Render grab
    const ImU32 grab_col = GetColorU32(ImGuiCol_SliderGrab/*held ? ImGuiCol_ScrollbarGrabActive : hovered ? ImGuiCol_ScrollbarGrabHovered : ImGuiCol_ScrollbarGrab*/, alpha);
    ImRect grab_rect;
    if (horizontal)
    ...
    else
    {
        ...
        else
        {
           // window->DrawList->AddRectFilled(bb_inner.Min, bb_inner.Max, GetColorU32(ImVec4(0, 0, 0, 1.f)));
            //window->DrawList->AddRectFilledMultiColor(bb_inner.Min, bb_inner.Max, GetColorU32(col_source), GetColorU32(col_source), GetColorU32(ImVec4(col_source.x, col_source.y, col_source.z, col_source.w - 0.2f)), GetColorU32(ImVec4(col_source.x, col_source.y, col_source.z, col_source.w - 0.2f)));//
