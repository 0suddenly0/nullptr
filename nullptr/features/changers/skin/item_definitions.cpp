...
std::vector<weapon_name> k_t_knife_names =
{
	{0,                            "default"},
...
std::vector<weapon_name> k_ct_knife_names =
{
	{0,                            "default"},
	{WEAPON_KNIFE_T,               "default t"},
	{WEAPON_KNIFE,                 "default ct"},
...
std::vector<weapon_name> k_t_glove_names =
{
{0, "default"},
...
std::vector<weapon_name> k_ct_glove_names =
{
{0, "default"},
{GLOVE_T_SIDE, "default t"},
{GLOVE_CT_SIDE, "default ct"},
...
std::vector<weapon_name> k_weapon_names =
{
...
{
	{0, "default"},
	{GLOVE_T_SIDE, "t_gloves"},
	{GLOVE_CT_SIDE, "ct_gloves"},
