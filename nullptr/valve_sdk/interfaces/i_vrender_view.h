...
public:
    ...
    virtual void                push_3d_view(const c_view_setup &view, int nFlags, i_texture* pRenderTarget, Frustum frustumPlanes) = 0;
    virtual void                push_2d_view(const c_view_setup &view, int nFlags, i_texture* pRenderTarget, Frustum frustumPlanes) = 0;
    ...
    virtual void                push_3d_view(const c_view_setup &view, int nFlags, i_texture* pRenderTarget, Frustum frustumPlanes, i_texture* pDepthTexture) = 0;
