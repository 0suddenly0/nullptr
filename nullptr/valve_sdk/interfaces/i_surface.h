...
public:
    ...
    virtual void          draw_filled_rect_array(int_rect *pRects, int numRects) = 0;
    ...
    virtual void          draw_print_text(const wchar_t *text, int textLen, font_draw_type drawType = font_draw_type::FONT_DRAW_DEFAULT) = 0;
    virtual void          draw_unicode_char(wchar_t wch, font_draw_type drawType = font_draw_type::FONT_DRAW_DEFAULT) = 0;
    ...
    virtual void          drawOutlined_circle(int x, int y, int radius, int segments) = 0;
